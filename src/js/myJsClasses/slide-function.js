...
export const slideDown = (target, duration, currentHeight) => {
...
export const slideToggle = (target, duration) => {
...
export const resetItemProperty = (target) => {
    target.style.removeProperty('height');
    target.style.removeProperty('padding-top');
    target.style.removeProperty('padding-bottom');
    target.style.removeProperty('margin-top');
...
export const stopItemTransition = (target) => {
